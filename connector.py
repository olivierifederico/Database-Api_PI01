from peewee import MySQLDatabase, Model, CharField, PrimaryKeyField, IntegerField,DateField,fn,SQL
...
conexion = MySQLDatabase(DBNAME,user = DBUSER, password = DBKEY)
